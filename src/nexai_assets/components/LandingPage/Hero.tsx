import { Box, Button, Stack, Text, Heading, Flex, HStack, useMediaQuery, Drawer, DrawerBody, DrawerContent, DrawerHeader, DrawerOverlay, List, ListItem } from "@chakra-ui/react";
                ...
                >
                    ...
                    >
                        <Stack spacing={6}>
                            ...
                            <Text>
                                Unleash Nexai's Powerful Assistance to Prioritize Customer Needs, Empowering You to Build the Next Unicorn while Providing Top-notch Support.
                            </Text>
                            <Button
                                color={`primary.50`}
                                width={32}
