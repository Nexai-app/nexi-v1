  ...
  return (
    <Box color={`primary.50`} bg="white">
      ...
      <Grid
        ...
        templateRows={
          isLargerThan650 ? `repeat(2, 1fr)` : `repeat(3, 1fr)`
        }
        h={`90%`}
        gap={6}
        mt={14}
      >
        <GridItem
          ...
          borderRadius={4}
        >
          <Stack color={`white`} width={isLargerThan650 ? `50%` : ``}>
            {isLargerThan650 ? (
              <Flex>
                <Image src={`01.svg`} />
              </Flex>
            ...
            <Text fontSize={`sm`}>
              Nexai offers an all-in-one customer support solution.
              Through self-learning from frequently asked questions,
              it intelligently suggests answers to users, ensuring
        ...
        >
          <Stack>
            ...
            <Heading size={`lg`}>
              Informed Responses from Company Documentation
            </Heading>
            <Text fontSize={`sm`}>
              There is an unparalleled knowledge base. Nexai goes
              beyond the ordinary by answering user questions directly
              from the company's documentation. It taps into the
              wealth of information, providing users with accurate and
              informed responses.
            </Text>
          </Stack>
        </GridItem>
        ...
        >
          <Stack>
            ...
            <Text fontSize={`sm`}>
              Nexai transforms customer support with a direct live
              agent chat feature. Elevate your support game by
              facilitating real-time interactions, ensuring that users
              receive immediate assistance and personalized support.
            </Text>
          </Stack>
        </GridItem>
      </Grid>
