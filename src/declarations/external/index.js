...
import { idlFactory } from './external.did.js';
export { idlFactory } from './external.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.EXTERNAL_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./external.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the external canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./external.did.js")._SERVICE>}
 */
export const external = createActor(canisterId);
