...
import { idlFactory } from './ic_files.did.js';
export { idlFactory } from './ic_files.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.IC_FILES_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./ic_files.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the ic_files canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./ic_files.did.js")._SERVICE>}
 */
export const ic_files = createActor(canisterId);
