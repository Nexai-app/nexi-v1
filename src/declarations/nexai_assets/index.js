...
import { idlFactory } from './nexai_assets.did.js';
export { idlFactory } from './nexai_assets.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.NEXAI_ASSETS_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./nexai_assets.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the nexai_assets canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./nexai_assets.did.js")._SERVICE>}
 */
export const nexai_assets = createActor(canisterId);
